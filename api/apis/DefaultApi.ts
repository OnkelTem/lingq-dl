...
export class DefaultApi extends runtime.BaseAPI {
   ...
   * Get collection data
   */
  async langCollectionsIdGetRaw(
    requestParameters: LangCollectionsIdGetRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<Collection>> {
    if (requestParameters.lang === null || requestParameters.lang === undefined) {
      throw new runtime.RequiredError(
        'lang',
        'Required parameter requestParameters.lang was null or undefined when calling langCollectionsIdGet.',
      );
    }
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling langCollectionsIdGet.',
      );
    }
   ...
   * Get lessson data
   */
  async langLessonsIdGetRaw(
    requestParameters: LangLessonsIdGetRequest,
    initOverrides?: RequestInit,
  ): Promise<runtime.ApiResponse<Lesson>> {
    if (requestParameters.lang === null || requestParameters.lang === undefined) {
      throw new runtime.RequiredError(
        'lang',
        'Required parameter requestParameters.lang was null or undefined when calling langLessonsIdGet.',
      );
    }
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling langLessonsIdGet.',
      );
    }
